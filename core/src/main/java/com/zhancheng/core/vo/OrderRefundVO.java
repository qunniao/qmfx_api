...
public class OrderRefundVO {
	...
	@ApiModelProperty(name = "refundState", value = "退货状态：0退款失败，1等待商家回应，2商家正在处理中，4退款成功,5用户已撤销退款")
	...
	@ApiModelProperty(name = "orderProductVO", value = "退款的商品信息")
	private OrderProductVO orderProductVO;

	@ApiModelProperty(name = "orderVO", value = "退款的订单信息")
